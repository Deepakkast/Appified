import * as app.appified.Config from '@oclif/config';
...
export default abstract class Command {
    argv: string[];
    config: app.appified.Config.IConfig;
    static _base: string;
    ...
    static plugin: app.appified.Config.IPlugin | undefined;
     ...
     */
    static run: app.appified.Config.Command.Class['run'];
    id: string | undefined;
    protected debug: (...args: any[]) => void;
    constructor(argv: string[], config: app.appified.Config.IConfig);
