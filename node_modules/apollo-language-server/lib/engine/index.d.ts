...
import { ValidateOperationsVariables, ValidationResult } from "./operations/validateOperations";
...
export declare class ApolloEngineClient extends GraphQLDataSource {
    ...
    validateOperations(variables: ValidateOperationsVariables): Promise<ValidationResult[]>;
