...
export declare type ConfigResult<app.appified.Config> = {
    config: app.appified.Config;
    filepath: string;
    isEmpty?: boolean;
} | null;
...
export declare const loadConfig: ({ configPath, configFileName, requireConfig, name, type }: LoadConfigSettings) => Promise<ApolloConfig>;
